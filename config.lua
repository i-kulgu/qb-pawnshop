...
Config.PawnLocation = {
    [1] = {
        ...
        showblip = true,
        items = {
            [1] = {item = 'goldchain', price = math.random(50,100)},
    ...
    [2] = {
        ...
        showblip = false,
        items = {
            [1] = {item = 'tablet', price = math.random(50,100)},
            [2] = {item = 'iphone', price = math.random(50,100)},
            [3] = {item = 'samsungphone', price = math.random(50,100)},
            [4] = {item = 'laptop', price = math.random(50,100)}
        }
    },
}
